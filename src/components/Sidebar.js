...
const Sidebar = () => {
  ...
  const softwareDatabase = {
    ...
    '3dpassport': {
      ...
      description: 'Dassault Systèmes 3DPassport',
      installerPath: '3DPassport-V6R2025x.HF4.Windows64.zip',
      command: 'echo "ZIP file requires manual extraction and installation"',
    ...
    'tomcat': {
      ...
      command: 'echo "ZIP file requires manual extraction and configuration"',
      requiresExtraction: true
    },
    'gradle': {
      ...
      command: 'echo "ZIP file requires manual extraction and PATH configuration"',
      requiresExtraction: true
    },
    'oracle': {
      ...
      command: 'echo "ZIP file requires manual extraction and database setup"',
      requiresExtraction: true
    }
  };
  ...
  const getSoftwareInfo = (filename) => {
    ...
    return {
      ...
      command: isZipFile 
        ? 'echo "ZIP file requires manual extraction before installation"'
        : `start /wait "" "{path}"`,
